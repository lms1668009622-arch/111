...
(function(global) {
  ...
  const DRONES = [
    ...
    { id: 'UAV-B3', name: '运输蜂-B3', type: 'transport', model: 'Y-5 运输型', status: 'mission', battery: 33, altitude: 650, speed: 120, signal: 72, lat: 23.674, lng: 120.078, missionId: 'M002', visibleImg: 'images/可见光1.png', thermalImg: 'images/热红外1.png' },
    { id: 'UAV-B4', name: '攻击蜂-B4', type: 'attack', model: 'Wing Loong II 攻击型', status: 'mission', battery: 58, altitude: 820, speed: 205, signal: 88, lat: 23.692, lng: 120.022, missionId: 'M002', visibleImg: 'images/可见光4.png', thermalImg: 'images/热红外4.png' },
    { id: 'UAV-B5', name: '侦察蜂-B5', type: 'scout', model: 'CH-5 侦察型', status: 'mission', battery: 82, altitude: 780, speed: 198, signal: 94, lat: 23.688, lng: 120.058, missionId: 'M002', visibleImg: 'images/可见光5.png', thermalImg: 'images/热红外5.png' },
